...
export const Route = createLazyFileRoute('/')({
  component: () => {
    ...
    return (
      <div className='m-2 mx-auto max-w-5xl text-slate-300'>
        ...
        <p className='mb-3'>
          Along your travels in Wraeclast, you will venture into the jungles of
          the <strong>Vaal Empire</strong>.
        </p>
        <p className='mb-3'>
          Here in the <strong>Chimeral Wetlands</strong>, you will discover the
          entrance to the <strong>Temple of Chaos</strong>, a place of great
          power and danger, where you will need to complete the Trialmaster's
          Challenges known as the <strong>Trials of Chaos.</strong>
        </p>
        <p className='mb-3'>
        ...
        <p className='mb-3'>
          ...
          sacrifice. This will allow you to begin a Trial of 4 rooms consisting
          of killing monsters, surviving an onslaught, one intricate objective,
          and defeating a powerful boss.
        </p>
        <p className='mb-3'>
        ...
        <p className='mb-3'>
          Beyond the initial quest, the <strong>Trials of Chaos</strong> extend
          into endgame. You can find <strong>Inscribed Ultimatums</strong> that
          contain up to 10 rooms. These allow you to take on even greater risks
          for more substantial rewards, acquire more Ascendancy Points, and
          ultimately face the <strong>Trialmaster</strong> himself in a
          challenging pinnacle fight.
        </p>
        <p>
          If you falter and die, you will lose all your rewards and the Trial
          will end, requiring another <strong>Ultimatum</strong> to enter a new
          Trial.
        </p>
        ...
        <div className='my-8 ml-10 flex w-2/5 items-center justify-between'>
          {modifiers.map((modifier) => (
            <div
              key={modifier.id}
              className={`mx-2 my-8 flex h-48 w-60 flex-col items-center justify-center rounded-lg`}
            >
        ...
        <p className='mb-3'>
          If your luck has run out, you may also choose to take the rewards you
          have earned and leave the Trial early.
        </p>
        <p className='mb-3'>
