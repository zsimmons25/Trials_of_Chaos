...
export const ItemData = Type.Object({
  ...
  socket1effect: Type.Union([Type.String(), Type.Null()]),
  socket1type: Type.Union([Type.String(), Type.Null()]),
  socket2effect: Type.Union([Type.String(), Type.Null()]),
  socket2type: Type.Union([Type.String(), Type.Null()]),
  socket3effect: Type.Union([Type.String(), Type.Null()]),
  socket3type: Type.Union([Type.String(), Type.Null()]),
