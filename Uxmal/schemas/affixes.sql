...
('IncreasedEnergyShield1', 'Resplendent', 79, 63, '+(91-96) to maximum Energy Shield', 'int_armour', 'defenses', 1000, 'BaseDefences'),
('AddedLightningDamageTwoHand10', 'Humming', 1, 1, 'Adds 1 to (7-10) Lightning Damage', 'two_hand_weapon', 'elemental_damage, elemental, damage, lightning, attack', 1100, 'LightningDamage'),
...
('Strength5', 'Gorilla', 44, 35 , '+(21-24) Strength', 'ring, amulet, belt, str_armour, mace, sword, axe, spear, flail, crossbow, sceptre', 'attribute', 1000, 'Strength'),
