...
-- Ruby
-- //
('RubyAreaOfEffect', 'Blasting', 1, 1, '(4-6)% increased Area of Effect', 'ruby', '', 1000, 'RubyAreaOfEffect'),
('RubyArmour', 'Armoured', 1, 1, '(10-20)% increased Armour', 'ruby', 'defences', 1000, 'Armour'),
('RubyBreakArmour', 'Shattering', 1, 1, 'Break (5-15)% increased Armour', 'ruby', 'Break', 1000, 'ArmourBreak'),
('RubyAttackDamage', 'Combat', 1, 1, '(5-15)% increased Attack Damage', 'ruby', 'damage,attack', 1000, 'RubyAttackDamage'),
('RubyBleedChance', 'Bleeding', 1, 1, '(3-7)% chance to inflict Bleeding on Hit', 'ruby', '', 1000, 'BleedChance'),
('RubyBlockChance', 'Protecting', 1, 1, '(3-7)% increased Block chance', 'ruby', '', 1000, 'BlockChance'),
('RubyBreakDamage', 'Exploiting', 1, 1, '(15-25)% increased Damage against Enemies with Fully Broken Armour', 'ruby', 'damage', 1000, 'BreakDamage'),
('RubyElementalDamage', 'Prismatic', 1, 1, '(5-15)% increased Elemental Damage', 'ruby', 'damage,elemental', 1000, 'RubyElementalDamage'),
('RubyEmpoweredAttack', 'Empowering', 1, 1, 'Empowered Attacks deal (10-20)% increased Damage', 'ruby', 'damage,attack', 1000, 'EmpoweredAttack'),
('RubyFireDamage', 'Flaming', 1, 1, '(5-15)% increased Fire Damage', 'ruby', 'damage,elemental,fire', 1000, 'FireDamage'),
('RubyFirePen', 'Searing', 1, 1, 'Damage Penetrates (5-10)% Fire Resistance', 'ruby', 'damage,elemental,fire', 1000, 'FirePenetration'),
('RubyIgniteMag', 'Burning', 1, 1, '(5-15)% increased Magnitude of Ignite you inflict', 'ruby', '', 1000, 'RubyIgniteMagnitude'),
('RubyMaceDamage', 'Beating', 1, 1, '(6-16)% increased Damage with Maces', 'ruby', 'damage,attack', 1000, 'MaceDamage'),
('RubyMaxRage', 'Angry', 1, 1, '+1 to Maximum Rage', 'ruby', '', 1000, 'MaxRage'),
('RubyMeleeDamage', 'Clashing', 1, 1, '(5-15)% increased Melee Damage', 'ruby', 'damage,attack', 1000, 'MeleeDamage'),
('RubyMinionAoE', 'Companion', 1, 1, 'Minions have (5-10)% increased Area of Effect', 'ruby', 'minion', 1000, 'MinionAoE'),
('RubyMinionLife', 'Fortuitous', 1, 1, 'Minions have (5-15)% increased maximum Life', 'ruby', 'life,minion', 1000, 'MinionLife'),
('RubyGlobalPhys', 'Sharpened', 1, 1, '(5-15)% increased Global Physical Damage', 'ruby', 'damage,physical', 1000, 'GlobalPhysicalDamage'),
('RubyShieldDef', 'Shielding', 1, 1, '(18-32)% increased Defences from Equipped Shield', 'ruby', 'defences', 1000, 'ShieldDefences'),
('RubyBleedMag', 'Haemorrhaging', 1, 1, '(5-15)% increased Magnitude of Bleeding you inflict', 'ruby', 'bleed,damage,physical,attack,ailment', 1000, 'BleedMagnitude'),
('RubyThorns', 'Retaliating', 1, 1, '(10-20)% increased Thorns damage', 'ruby', 'damage', 1000, 'ThornsDamage'),
('RubyTotemDamage', 'Shamans', 1, 1, '(10-18)% increased Totem Damage', 'ruby', 'damage', 1000, 'TotemDamage'),
('RubyTotemLife', 'Carved', 1, 1, '(10-20)% increased Totem Life', 'ruby', 'life', 1000, 'TotemLife'),
-- ('RubyWarcryBuff', 'Warcries', 1, 1, '(5-15)% increased Warcry Buff Effect', 'ruby', '', 1000, 'WarcryBuffEffect'),
('RubyWarcryDamage', 'Yelling', 1, 1, '(10-20)% increased Damage with Warcries', 'ruby', 'damage', 1000, 'WarcryDamage'),
('RubyIncision', 'Incise', 1, 1, '(15-25)% chance for Attack Hits to apply Incision', 'ruby', 'bleed,damage,physical,ailment', 1000, 'IncisionChance'),
('RubyBannerAoE', 'Rallying', 1, 1, 'Banner Skills have (10-20)% increased Area of Effect', 'ruby', '', 1000, 'BannerAoE'),
('RubyPresenceAoE', 'Iconic', 1, 1, '(15-25)% increased Presence Area of Effect', 'ruby', '', 1000, 'RubyPresenceAoE'),

-- //
-- Emerald
-- //
('EmeraldAccuracy', 'Accurate', 1, 1, '(5-10)% increased Accuracy Rating', 'emerald', '', 1000, 'Accuracy'),
('EmeraldAilmentMag', 'Acrimonious', 1, 1, '(5-15)% increased Magnitude of Ailments you inflict', 'emerald', 'damage,ailment', 1000, 'EmeraldAilmentMagnitude'),
('EmeraldAttackDamage', 'Combat', 1, 1, '(5-15)% increased Attack Damage', 'emerald', 'damage,attack', 1000, 'EmeraldAttackDamage'),
('EmeraldBlindEffect', 'Stifling', 1, 1, '(5-10)% increased Blind Effect', 'emerald', '', 1000, 'BlindEffect'),
('EmeraldRareUniqueDamage', 'Slaying', 1, 1, '(10-20)% increased Damage with Hits against Rare and Unique Enemies', 'emerald', 'damage', 1000, 'RareUniqueDamage'),
('EmeraldBowAccuracy', 'Precise', 1, 1, '(5-15)% increased Accuracy Rating with Bows', 'emerald', 'attack', 1000, 'BowAccuracy'),
('EmeraldBowDamage', 'Perforating', 1, 1, '(5-15)% increased Damage with Bows', 'emerald', 'damage,attack', 1000, 'WeaponDamage'),
('EmeraldQuarterstaffDamage', 'Monks', 1, 1, '(5-15)% increased Damage with Quarterstaves', 'emerald', '', 1000, 'WeaponDamage'),
('EmeraldCharmDamage', 'Verdant', 1, 1, '(10-20)% increased Damage while you have an active Charm', 'emerald', '', 1000, 'CharmDamage'),
('EmeraldCritAilmentMag', 'Rancorous', 1, 1, '(10-20)% increased Magnitude of Damaging Ailments you inflict with Critical Hits', 'emerald', 'damage,critical,ailment', 1000, 'EmeraldCritAilmentMagnitude'),
('EmeraldCrossbowDamage', 'Bolting', 1, 1, '(6-16)% increased Damage with Crossbows', 'emerald', 'damage,attack', 1000, 'CrossbowDamage'),
('EmeraldElementalDamage', 'Prismatic', 1, 1, '(5-15)% increased Elemental Damage', 'emerald', 'damage,elemental', 1000, 'EmeraldElementalDamage'),
('EmeraldEvasion', 'Evasive', 1, 1, '(10-20)% increased Evasion Rating', 'emerald', 'defences', 1000, 'Evasion'),
('EmeraldHeraldDamage', 'Heralding', 1, 1, 'Herald Skills deal (15-25)% increased Damage', 'emerald', '', 1000, 'HeraldDamage'),
('EmeraldLightningDamage', 'Humming', 1, 1, '(5-15)% increased Lightning Damage', 'emerald', 'damage,elemental,lightning', 1000, 'LightningDamage'),
('EmeraldLightningPen', 'Surging', 1, 1, 'Damage Penetrates (5-10)% Lightning Resistance', 'emerald', 'damage,elemental,lightning', 1000, 'LightningPenetration'),
('EmeraldMarkEffect', 'Marking', 1, 1, '(4-8)% increased Effect of your Mark Skills', 'emerald', 'caster,curse', 1000, 'MarkEffect'),
('EmeraldPoisonMag', 'Venomous', 1, 1, '(5-15)% increased Magnitude of Poison you inflict', 'emerald', 'damage,ailment', 1000, 'PoisonMagnitude'),
('EmeraldProjectileDamage', 'Archers', 1, 1, '(5-15)% increased Projectile Damage', 'emerald', 'damage', 1000, 'ProjectileDamage'),
('EmeraldProjectileSpeed', 'Soaring', 1, 1, '(4-8)% increased Projectile Speed', 'emerald', 'speed', 1000, 'ProjectileSpeed'),
('EmeraldQuiverBonus', 'Fletching', 1, 1, '(4-6)% increased bonuses gained from Equipped Quiver', 'emerald', '', 1000, 'QuiverBonus'),
('EmeraldShockMag', 'Jolting', 1, 1, '(10-15)% increased Magnitude of Shock you inflict', 'emerald', 'elemental,lightning,ailment', 1000, 'EmeraldShockMagnitude'),
('EmeraldProjDmgAfterMelee', 'Retreating', 1, 1, '(10-20)% increased Projectile Damage if you have dealt a Melee Hit in the past eight seconds', 'emerald', 'damage,attack', 1000, 'ProjectileAfterMelee'),
('EmeraldMeleeDmgAfterProjectile', 'Engaging', 1, 1, '(10-20)% increased Melee Damage if you have dealt a Projectile Attack Hit in the past eight seconds', 'emerald', 'damage,attack', 1000, 'MeleeAfterProjectile'),
('EmeraldParryDamage', 'Parrying', 1, 1, '(15-25)% increased Parry Damage', 'emerald', '', 1000, 'ParryDamage'),
('EmeraldMinionDamage', 'Kinship', 1, 1, 'Companions deal (10-20)% increased Damage', 'emerald', 'damage,minion', 1000, 'CompanionDamage'),
('EmeraldMinionLife', 'Kindred', 1, 1, 'Companions have (10-20)% increased maximum Life', 'emerald', 'life,minion', 1000, 'CompanionLife'),
('EmeraldHazardDamage', 'Hazardous', 1, 1, '(10-20)% increased Hazard Damage', 'emerald', 'damage', 1000, 'HazardDamage'),

-- //
-- Sapphire
-- //
('SapphireAilmentMag', 'Acrimonious', 1, 1, '(5-15)% increased Magnitude of Ailments you inflict', 'sapphire', 'damage,ailment', 1000, 'SapphireAilmentMagnitude'),
('SapphireAreaOfEffect', 'Blasting', 1, 1, '(4-6)% increased Area of Effect', 'sapphire', '', 1000, 'SapphireAreaOfEffect'),
('SapphireAuraMag', 'Commanding', 1, 1, 'Aura Skills have (3-7)% increased Magnitudes', 'sapphire', 'aura', 1000, 'AuraMagnitude'),
('SapphireChaosDamage', 'Chaotic', 1, 1, '(6-12)% increased Chaos Damage', 'sapphire', 'damage,chaos', 1000, 'ChaosDamage'),
('SapphireColdDamage', 'Chilling', 1, 1, '(5-15)% increased Cold Damage', 'sapphire', 'damage,elemental,cold', 1000, 'ColdDamage'),
('SapphireColdPen', 'Numbing', 1, 1, 'Damage Penetrates (5-10)% Cold Resistance', 'sapphire', 'damage,elemental,cold', 1000, 'ColdPenetration'),
('SapphireCorpseDamage', 'Necromantic', 1, 1, '(10-20)% increased Damage if you have Consumed a Corpse Recently', 'sapphire', 'damage', 1000, 'CorpseDamage'),
('SapphireCritAilmentMag', 'Rancorous', 1, 1, '(10-20)% increased Magnitude of Damaging Ailments you inflict with Critical Hits', 'sapphire', 'damage,critical,ailment', 1000, 'SapphireCritAilmentMagnitude'),
('SapphireCurseAoE', 'Expanding', 1, 1, '(15-25)% increased Area of Effect of Curses', 'sapphire', 'caster,curse', 1000, 'CurseAreaOfEffect'),
('SapphireCurseMag', 'Hexing', 1, 1, '(2-4)% increased Curse Magnitudes', 'sapphire', 'caster,curse', 1000, 'CurseMagnitude'),
('SapphireElementalDamage', 'Prismatic', 1, 1, '(5-15)% increased Elemental Damage', 'sapphire', 'damage,elemental', 1000, 'SapphireElementalDamage'),
('SapphireEnergyShield', 'Shimmering', 1, 1, '(10-20)% increased maximum Energy Shield', 'sapphire', 'defences', 1000, 'EnergyShield'),
('SapphireESRechargeStart', 'Serene', 1, 1, '(10-15)% faster start of Energy Shield Recharge', 'sapphire', 'defences', 1000, 'EnergyShieldRechargeStart'),
('SapphireESRechargeRate', 'Fevered', 1, 1, '(10-20)% increased Energy Shield Recharge Rate', 'sapphire', 'defences', 1000, 'EnergyShieldRechargeRate'),
('SapphireESFromFocus', 'Focusing', 1, 1, '(30-50)% increased Energy Shield from Equipped Focus', 'sapphire', 'defences', 1000, 'EnergyShieldFromFocus'),
('SapphireIgniteMag', 'Burning', 1, 1, '(5-15)% increased Magnitude of Ignite you inflict', 'sapphire', '', 1000, 'SapphireIgniteMagnitude'),
('SapphireMinionAccuracy', 'Training', 1, 1, '(10-20)% increased Minion Accuracy Rating', 'sapphire', 'attack,minion', 1000, 'MinionAccuracy'),
('SapphireMinionDamage', 'Authoritative', 1, 1, 'Minions deal (5-15)% increased Damage', 'sapphire', 'damage,minion', 1000, 'MinionDamage'),
('SapphireOfferingLife', 'Sacrificial', 1, 1, 'Offerings have (15-25)% increased Maximum Life', 'sapphire', '', 1000, 'OfferingLife'),
('SapphireShockMag', 'Jolting', 1, 1, '(10-15)% increased Magnitude of Shock you inflict', 'sapphire', 'elemental,lightning,ailment', 1000, 'SapphireShockMagnitude'),
('SapphireSpellDamage', 'Mystic', 1, 1, '(5-15)% increased Spell Damage', 'sapphire', 'damage,caster', 1000, 'SpellDamage'),
('SapphireTriggeredSpellDamage', 'Triggered', 1, 1, 'Triggered Spells deal (10-18)% increased Spell Damage', 'sapphire', 'damage,caster', 1000, 'TriggeredSpellDamage'),
('SapphireWitheredEffect', 'Withering', 1, 1, '(5-10)% increased Effect of Withered', 'sapphire', 'chaos', 1000, 'WitheredEffect'),
('SapphirePresenceAoE', 'Iconic', 1, 1, '(15-25)% increased Presence Area of Effect', 'sapphire', '', 1000, 'SapphirePresenceAoE'),
...
-- Spell Physical
('SpellPhysicalDamage1', 'Torturer', 81, 64, '(105-119)% increased Spell Physical Damage', 'wand, focus', 'damage,physical', 50, 'SpellDamageType'),
('SpellPhysicalDamage2', 'Oppressor', 71, 56, '(90-104)% increased Spell Physical Damage', 'wand, focus', 'damage,physical', 100, 'SpellDamageType'),
('SpellPhysicalDamage3', 'Agonising', 59, 47, '(75-89)% increased Spell Physical Damage', 'wand, focus', 'damage,physical', 200, 'SpellDamageType'),
('SpellPhysicalDamage4', 'Pitiless', 47, 37, '(65-74)% increased Spell Physical Damage', 'wand, focus', 'damage,physical', 300, 'SpellDamageType'),
('SpellPhysicalDamage5', 'Sadistic', 36, 28, '(55-64)% increased Spell Physical Damage', 'wand, focus', 'damage,physical', 400, 'SpellDamageType'),
('SpellPhysicalDamage6', 'Vengeful', 24, 19, '(45-54)% increased Spell Physical Damage', 'wand, focus', 'damage,physical', 500, 'SpellDamageType'),
('SpellPhysicalDamage7', 'Unforgiving', 12, 9, '(35-44)% increased Spell Physical Damage', 'wand, focus', 'damage,physical', 500, 'SpellDamageType'),
('SpellPhysicalDamage8', 'Punishing', 2, 1, '(25-34)% increased Spell Physical Damage', 'wand, focus', 'damage,physical', 500, 'SpellDamageType'),

-- Spell Fire
('SpellFireDamage1', 'Pyromancer', 81, 64, '(105-119)% increased Fire Damage', 'wand, focus', 'damage,elemental,fire', 50, 'SpellDamageType'),
('SpellFireDamage2', 'Volcanic', 71, 56, '(90-104)% increased Fire Damage', 'wand, focus', 'damage,elemental,fire', 100, 'SpellDamageType'),
('SpellFireDamage3', 'Magmatic', 59, 47, '(75-89)% increased Fire Damage', 'wand, focus', 'damage,elemental,fire', 200, 'SpellDamageType'),
('SpellFireDamage4', 'Smoldering', 47, 37, '(65-74)% increased Fire Damage', 'wand, focus', 'damage,elemental,fire', 300, 'SpellDamageType'),
('SpellFireDamage5', 'Cauterising', 36, 28, '(55-64)% increased Fire Damage', 'wand, focus', 'damage,elemental,fire', 400, 'SpellDamageType'),
('SpellFireDamage6', 'Blistering', 24, 19, '(45-54)% increased Fire Damage', 'wand, focus', 'damage,elemental,fire', 500, 'SpellDamageType'),
('SpellFireDamage7', 'Sizzling', 12, 9, '(35-44)% increased Fire Damage', 'wand, focus', 'damage,elemental,fire', 500, 'SpellDamageType'),
('SpellFireDamage8', 'Searing', 2, 1, '(25-34)% increased Fire Damage', 'wand, focus', 'damage,elemental,fire', 500, 'SpellDamageType'),

-- Spell Cold
('SpellColdDamage1', 'Cryomancer', 81, 64, '(105-119)% increased Cold Damage', 'wand, focus', 'damage,elemental,cold', 50, 'SpellDamageType'),
('SpellColdDamage2', 'Crystalline', 71, 56, '(90-104)% increased Cold Damage', 'wand, focus', 'damage,elemental,cold', 100, 'SpellDamageType'),
('SpellColdDamage3', 'Arctic', 59, 47, '(75-89)% increased Cold Damage', 'wand, focus', 'damage,elemental,cold', 200, 'SpellDamageType'),
('SpellColdDamage4', 'Hailing', 47, 37, '(65-74)% increased Cold Damage', 'wand, focus', 'damage,elemental,cold', 300, 'SpellDamageType'),
('SpellColdDamage5', 'Snowy', 36, 28, '(55-64)% increased Cold Damage', 'wand, focus', 'damage,elemental,cold', 400, 'SpellDamageType'),
('SpellColdDamage6', 'Alpine', 24, 19, '(45-54)% increased Cold Damage', 'wand, focus', 'damage,elemental,cold', 500, 'SpellDamageType'),
('SpellColdDamage7', 'Biting', 12, 9, '(35-44)% increased Cold Damage', 'wand, focus', 'damage,elemental,cold', 500, 'SpellDamageType'),
('SpellColdDamage8', 'Bitter', 2, 1, '(25-34)% increased Cold Damage', 'wand, focus', 'damage,elemental,cold', 500, 'SpellDamageType'),

-- Spell Lightning
('SpellLightningDamage1', 'Electromancer', 81, 64, '(105-119)% increased Lightning Damage', 'wand, focus', 'damage,elemental,lightning', 50, 'SpellDamageType'),
('SpellLightningDamage2', 'Ionising', 71, 56, '(90-104)% increased Lightning Damage', 'wand, focus', 'damage,elemental,lightning', 100, 'SpellDamageType'),
('SpellLightningDamage3', 'Smiting', 59, 47, '(75-89)% increased Lightning Damage', 'wand, focus', 'damage,elemental,lightning', 200, 'SpellDamageType'),
('SpellLightningDamage4', 'Striking', 47, 37, '(65-74)% increased Lightning Damage', 'wand, focus', 'damage,elemental,lightning', 300, 'SpellDamageType'),
('SpellLightningDamage5', 'Coursing', 36, 28, '(55-64)% increased Lightning Damage', 'wand, focus', 'damage,elemental,lightning', 400, 'SpellDamageType'),
('SpellLightningDamage6', 'Bolting', 24, 19, '(45-54)% increased Lightning Damage', 'wand, focus', 'damage,elemental,lightning', 500, 'SpellDamageType'),
('SpellLightningDamage7', 'Hissing', 12, 9, '(35-44)% increased Lightning Damage', 'wand, focus', 'damage,elemental,lightning', 500, 'SpellDamageType'),
('SpellLightningDamage8', 'Charged', 2, 1, '(25-34)% increased Lightning Damage', 'wand, focus', 'damage,elemental,lightning', 500, 'SpellDamageType'),

-- Spell Chaos
('SpellChaosDamage1', 'Malevolent', 81, 64, '(105-119)% increased Chaos Damage', 'wand, focus', 'damage,chaos', 50, 'SpellDamageType'),
('SpellChaosDamage2', 'Twisted', 71, 56, '(90-104)% increased Chaos Damage', 'wand, focus', 'damage,chaos', 100, 'SpellDamageType'),
('SpellChaosDamage3', 'Vile', 59, 47, '(75-89)% increased Chaos Damage', 'wand, focus', 'damage,chaos', 200, 'SpellDamageType'),
('SpellChaosDamage4', 'Malignant', 47, 37, '(65-74)% increased Chaos Damage', 'wand, focus', 'damage,chaos', 300, 'SpellDamageType'),
('SpellChaosDamage5', 'Darkened', 36, 28, '(55-64)% increased Chaos Damage', 'wand, focus', 'damage,chaos', 400, 'SpellDamageType'),
('SpellChaosDamage6', 'Clouded', 24, 19, '(45-54)% increased Chaos Damage', 'wand, focus', 'damage,chaos', 500, 'SpellDamageType'),
('SpellChaosDamage7', 'Tainted', 12, 9, '(35-44)% increased Chaos Damage', 'wand, focus', 'damage,chaos', 500, 'SpellDamageType'),
('SpellChaosDamage8', 'Impure', 2, 1, '(25-34)% increased Chaos Damage', 'wand, focus', 'damage,chaos', 500, 'SpellDamageType'),
...
-- Spell Physical
('SpellPhysicalDamageStaff1', 'Torturer', 81, 64, '(150-169)% increased Spell Physical Damage', 'staff', 'damage,physical', 50, 'SpellDamageType'),
('SpellPhysicalDamageStaff2', 'Oppressor', 71, 56, '(130-149)% increased Spell Physical Damage', 'staff', 'damage,physical', 100, 'SpellDamageType'),
('SpellPhysicalDamageStaff3', 'Agonising', 59, 47, '(110-129)% increased Spell Physical Damage', 'staff', 'damage,physical', 200, 'SpellDamageType'),
('SpellPhysicalDamageStaff4', 'Pitiless', 47, 37, '(95-109)% increased Spell Physical Damage', 'staff', 'damage,physical', 300, 'SpellDamageType'),
('SpellPhysicalDamageStaff5', 'Sadistic', 36, 28, '(80-94)% increased Spell Physical Damage', 'staff', 'damage,physical', 400, 'SpellDamageType'),
('SpellPhysicalDamageStaff6', 'Vengeful', 24, 19, '(65-79)% increased Spell Physical Damage', 'staff', 'damage,physical', 500, 'SpellDamageType'),
('SpellPhysicalDamageStaff7', 'Unforgiving', 12, 9, '(50-64)% increased Spell Physical Damage', 'staff', 'damage,physical', 500, 'SpellDamageType'),
('SpellPhysicalDamageStaff8', 'Punishing', 2, 1, '(35-49)% increased Spell Physical Damage', 'staff', 'damage,physical', 500, 'SpellDamageType'),

-- Spell Fire
('SpellFireDamageStaff1', 'Pyromancer', 81, 64, '(150-169)% increased Fire Damage', 'staff', 'damage,elemental,fire', 50, 'SpellDamageType'),
('SpellFireDamageStaff2', 'Volcanic', 71, 56, '(130-149)% increased Fire Damage', 'staff', 'damage,elemental,fire', 100, 'SpellDamageType'),
('SpellFireDamageStaff3', 'Magmatic', 59, 47, '(110-129)% increased Fire Damage', 'staff', 'damage,elemental,fire', 200, 'SpellDamageType'),
('SpellFireDamageStaff4', 'Smoldering', 47, 37, '(95-109)% increased Fire Damage', 'staff', 'damage,elemental,fire', 300, 'SpellDamageType'),
('SpellFireDamageStaff5', 'Cauterising', 36, 28, '(80-94)% increased Fire Damage', 'staff', 'damage,elemental,fire', 400, 'SpellDamageType'),
('SpellFireDamageStaff6', 'Blistering', 24, 19, '(65-79)% increased Fire Damage', 'staff', 'damage,elemental,fire', 500, 'SpellDamageType'),
('SpellFireDamageStaff7', 'Sizzling', 12, 9, '(50-64)% increased Fire Damage', 'staff', 'damage,elemental,fire', 500, 'SpellDamageType'),
('SpellFireDamageStaff8', 'Searing', 2, 1, '(35-49)% increased Fire Damage', 'staff', 'damage,elemental,fire', 500, 'SpellDamageType'),

-- Spell Cold
('SpellColdDamageStaff1', 'Cryomancer', 81, 64, '(150-169)% increased Cold Damage', 'staff', 'damage,elemental,cold', 50, 'SpellDamageType'),
('SpellColdDamageStaff2', 'Crystalline', 71, 56, '(130-149)% increased Cold Damage', 'staff', 'damage,elemental,cold', 100, 'SpellDamageType'),
('SpellColdDamageStaff3', 'Arctic', 59, 47, '(110-129)% increased Cold Damage', 'staff', 'damage,elemental,cold', 200, 'SpellDamageType'),
('SpellColdDamageStaff4', 'Hailing', 47, 37, '(95-109)% increased Cold Damage', 'staff', 'damage,elemental,cold', 300, 'SpellDamageType'),
('SpellColdDamageStaff5', 'Snowy', 36, 28, '(80-94)% increased Cold Damage', 'staff', 'damage,elemental,cold', 400, 'SpellDamageType'),
('SpellColdDamageStaff6', 'Alpine', 24, 19, '(65-79)% increased Cold Damage', 'staff', 'damage,elemental,cold', 500, 'SpellDamageType'),
('SpellColdDamageStaff7', 'Biting', 12, 9, '(50-64)% increased Cold Damage', 'staff', 'damage,elemental,cold', 500, 'SpellDamageType'),
('SpellColdDamageStaff8', 'Bitter', 2, 1, '(35-49)% increased Cold Damage', 'staff', 'damage,elemental,cold', 500, 'SpellDamageType'),

-- Spell Lightning
('SpellLightningDamageStaff1', 'Electromancer', 81, 64, '(150-169)% increased Lightning Damage', 'staff', 'damage,elemental,lightning', 50, 'SpellDamageType'),
('SpellLightningDamageStaff2', 'Ionising', 71, 56, '(130-149)% increased Lightning Damage', 'staff', 'damage,elemental,lightning', 100, 'SpellDamageType'),
('SpellLightningDamageStaff3', 'Smiting', 59, 47, '(110-129)% increased Lightning Damage', 'staff', 'damage,elemental,lightning', 200, 'SpellDamageType'),
('SpellLightningDamageStaff4', 'Striking', 47, 37, '(95-109)% increased Lightning Damage', 'staff', 'damage,elemental,lightning', 300, 'SpellDamageType'),
('SpellLightningDamageStaff5', 'Coursing', 36, 28, '(80-94)% increased Lightning Damage', 'staff', 'damage,elemental,lightning', 400, 'SpellDamageType'),
('SpellLightningDamageStaff6', 'Bolting', 24, 19, '(65-79)% increased Lightning Damage', 'staff', 'damage,elemental,lightning', 500, 'SpellDamageType'),
('SpellLightningDamageStaff7', 'Hissing', 12, 9, '(50-64)% increased Lightning Damage', 'staff', 'damage,elemental,lightning', 500, 'SpellDamageType'),
('SpellLightningDamageStaff8', 'Charged', 2, 1, '(35-49)% increased Lightning Damage', 'staff', 'damage,elemental,lightning', 500, 'SpellDamageType'),

-- Spell Chaos
('SpellChaosDamageStaff1', 'Malevolent', 81, 64, '(150-169)% increased Chaos Damage', 'staff', 'damage,chaos', 50, 'SpellDamageType'),
('SpellChaosDamageStaff2', 'Twisted', 71, 56, '(130-149)% increased Chaos Damage', 'staff', 'damage,chaos', 100, 'SpellDamageType'),
('SpellChaosDamageStaff3', 'Vile', 59, 47, '(110-129)% increased Chaos Damage', 'staff', 'damage,chaos', 200, 'SpellDamageType'),
('SpellChaosDamageStaff4', 'Malignant', 47, 37, '(95-109)% increased Chaos Damage', 'staff', 'damage,chaos', 300, 'SpellDamageType'),
('SpellChaosDamageStaff5', 'Darkened', 36, 28, '(80-94)% increased Chaos Damage', 'staff', 'damage,chaos', 400, 'SpellDamageType'),
('SpellChaosDamageStaff6', 'Clouded', 24, 19, '(65-79)% increased Chaos Damage', 'staff', 'damage,chaos', 500, 'SpellDamageType'),
('SpellChaosDamageStaff7', 'Tainted', 12, 9, '(50-64)% increased Chaos Damage', 'staff', 'damage,chaos', 500, 'SpellDamageType'),
('SpellChaosDamageStaff8', 'Impure', 2, 1, '(35-49)% increased Chaos Damage', 'staff', 'damage,chaos', 500, 'SpellDamageType'),
...
-- Physical Percent
('IncreasedPhysicalPercent1', 'Merciless', 82, 65, '(170-179)% increased Physical Damage', 'weapon, bow', 'damage, physical, attack', 25, 'PhysicalPercent'),
('IncreasedPhysicalPercent2', 'Tyrannical', 73, 58, '(155-169)% increased Physical Damage', 'weapon, bow', 'damage, physical, attack', 50, 'PhysicalPercent'),
('IncreasedPhysicalPercent3', 'Cruel', 60, 48, '(135-154)% increased Physical Damage', 'weapon, bow', 'damage, physical, attack', 100, 'PhysicalPercent'),
('IncreasedPhysicalPercent4', 'Bloodthirsty', 46, 36, '(110-134)% increased Physical Damage', 'weapon, bow', 'damage, physical, attack', 200, 'PhysicalPercent'),
('IncreasedPhysicalPercent5', 'Vicious', 35, 28, '(85-109)% increased Physical Damage', 'weapon, bow', 'damage, physical, attack', 400, 'PhysicalPercent'),
('IncreasedPhysicalPercent6', 'Wicked', 23, 18, '(65-84)% increased Physical Damage', 'weapon, bow', 'damage, physical, attack', 1000, 'PhysicalPercent'),
('IncreasedPhysicalPercent7', 'Serrated', 11, 8, '(50-64)% increased Physical Damage', 'weapon, bow', 'damage, physical, attack', 1000, 'PhysicalPercent'),
('IncreasedPhysicalPercent8', 'Heavy', 1, 1, '(40-49)% increased Physical Damage', 'weapon, bow', 'damage, physical, attack', 1000, 'PhysicalPercent'),

-- Physical Hybrid
('IncreasedPhysicalPercentAccuracy1', 'Dictator', 81, 64, '(75-79)% increased Physical Damage\n+(175-200) to Accuracy Rating', 'weapon, bow', 'damage, physical, attack', 100, 'PhysicalPercentAccuracy'),
('IncreasedPhysicalPercentAccuracy2', 'Emperor', 76, 60, '(65-74)% increased Physical Damage\n+(150-174) to Accuracy Rating', 'weapon, bow', 'damage, physical, attack', 200, 'PhysicalPercentAccuracy'),
('IncreasedPhysicalPercentAccuracy3', 'Conqueror', 65, 52, '(55-64)% increased Physical Damage\n+(124-149) to Accuracy Rating', 'weapon, bow', 'damage, physical, attack', 400, 'PhysicalPercentAccuracy'),
('IncreasedPhysicalPercentAccuracy4', 'Champion', 53, 42, '(45-54)% increased Physical Damage\n+(98-123) to Accuracy Rating', 'weapon, bow', 'damage, physical, attack', 600, 'PhysicalPercentAccuracy'),
('IncreasedPhysicalPercentAccuracy5', 'Mercenary', 38, 30, '(35-44)% increased Physical Damage\n+(73-97) to Accuracy Rating', 'weapon, bow', 'damage, physical, attack', 1000, 'PhysicalPercentAccuracy'),
('IncreasedPhysicalPercentAccuracy6', 'Reaver', 23, 18, '(25-34)% increased Physical Damage\n+(47-72) to Accuracy Rating', 'weapon, bow', 'damage, physical, attack', 1000, 'PhysicalPercentAccuracy'),
('IncreasedPhysicalPercentAccuracy7', 'Journeyman', 11, 8, '(20-24)% increased Physical Damage\n+(21-46) to Accuracy Rating', 'weapon, bow', 'damage, physical, attack', 1000, 'PhysicalPercentAccuracy'),
('IncreasedPhysicalPercentAccuracy8', 'Squire', 1, 1, '(15-19)% increased Physical Damage\n+(16-20) to Accuracy Rating', 'weapon, bow', 'damage, physical, attack', 1000, 'PhysicalPercentAccuracy'),

-- Accuracy
('Accuracy1', 'Amazon', 76, 60, '+(451-550) to Accuracy Rating', 'weapon, bow, quiver, helmet, gloves', 'attack', 200, 'Accuracy'),
('Accuracy2', 'Ranger', 63, 50, '+(347-450) to Accuracy Rating', 'weapon, bow, quiver, amulet, ring, helmet, gloves', 'attack', 300, 'Accuracy'),
('Accuracy3', 'Hunter', 50, 40, '+(237-346) to Accuracy Rating', 'weapon, bow, quiver, amulet, ring, helmet, gloves', 'attack', 600, 'Accuracy'),
('Accuracy4', 'Steady', 41, 32, '+(168-236) to Accuracy Rating', 'weapon, bow, quiver, amulet, ring, helmet, gloves', 'attack', 600, 'Accuracy'),
('Accuracy5', 'Consistent', 33, 26, '+(124-167) to Accuracy Rating', 'weapon, bow, quiver, amulet, ring, helmet, gloves', 'attack', 800, 'Accuracy'),
('Accuracy6', 'Deliberate', 26, 20, '+(85-123) to Accuracy Rating', 'weapon, bow, quiver, amulet, ring, helmet, gloves', 'attack', 800, 'Accuracy'),
('Accuracy7', 'Focused', 20, 16, '+(61-84) to Accuracy Rating', 'weapon, bow, quiver, amulet, ring, helmet, gloves', 'attack', 800, 'Accuracy'),
('Accuracy8', 'Reliable', 12, 9, '+(33-60) to Accuracy Rating', 'weapon, bow, quiver, amulet, ring, helmet, gloves', 'attack', 800, 'Accuracy'),
('Accuracy9', 'Precise', 1, 1, '+(11-32) to Accuracy Rating', 'weapon, bow, quiver, amulet, ring, helmet, gloves', 'attack', 800, 'Accuracy'),
...
('EnergyShield2', 'Incandescent', 74, 59, '+(81-90) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet', 'defences', 1000, 'EnergyShield'),
('EnergyShield3', 'Scintillating', 66, 52, '+(74-80) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet', 'defences', 1000, 'EnergyShield'),
('EnergyShield4', 'Dazzling', 59, 47, '+(61-73) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet, helmet', 'defences', 1000, 'EnergyShield'),
('EnergyShield5', 'Blazing', 47, 37, '+(48-60) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet, helmet, gloves, boots', 'defences', 1000, 'EnergyShield'),
('EnergyShield6', 'Pulsing', 35, 28, '+(42-47) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet, helmet, gloves, boots', 'defences', 1000, 'EnergyShield'),
('EnergyShield7', 'Radiating', 29, 23, '+(36-41) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet, helmet, gloves, boots', 'defences', 1000, 'EnergyShield'),
('EnergyShield8', 'Glowing', 23, 18, '+(31-35) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet, helmet, gloves, boots', 'defences', 1000, 'EnergyShield'),
('EnergyShield9', 'Glittering', 17, 13, '+(25-30) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet, helmet, gloves, boots', 'defences', 1000, 'EnergyShield'),
('EnergyShield10', 'Glimmering', 11, 8, '+(18-24) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet, helmet, gloves, boots', 'defences', 1000, 'EnergyShield'),
('EnergyShield11', 'Shining', 1, 1, '+(10-17) to maximum Energy Shield', 'int_armour, body_armour, focus, amulet, helmet, gloves, boots', 'defences', 1000, 'EnergyShield'),

-- Energy Shield Percent
('EnergyShieldPercent1', 'Unfaltering', 82, 65, '(101-110)% increased Energy Shield', 'int_armour, body_armour', 'defences', 1000, 'EnergyShieldPercent'),
('EnergyShieldPercent2', 'Unassailable', 75, 60, '(92-100)% increased Energy Shield', 'int_armour, body_armour, focus, helmet, gloves, boots', 'defences', 1000, 'EnergyShieldPercent'),
('EnergyShieldPercent3', 'Indomitable', 66, 52, '(80-91)% increased Energy Shield', 'int_armour, body_armour, focus, helmet, gloves, boots', 'defences', 1000, 'EnergyShieldPercent'),
('EnergyShieldPercent4', 'Dauntless', 51, 40, '(68-79)% increased Energy Shield', 'int_armour, body_armour, focus, helmet, gloves, boots', 'defences', 1000, 'EnergyShieldPercent'),
('EnergyShieldPercent5', 'Fearless', 39, 31, '(56-67)% increased Energy Shield', 'int_armour, body_armour, focus, helmet, gloves, boots', 'defences', 1000, 'EnergyShieldPercent'),
('EnergyShieldPercent6', 'Resolute', 27, 21, '(43-55)% increased Energy Shield', 'int_armour, body_armour, focus, helmet, gloves, boots', 'defences', 1000, 'EnergyShieldPercent'),
('EnergyShieldPercent7', 'Strong-Willed', 15, 12, '(27-42)% increased Energy Shield', 'int_armour, body_armour, focus, helmet, gloves, boots', 'defences', 1000, 'EnergyShieldPercent'),
('EnergyShieldPercent8', 'Protective', 2, 1, '(15-26)% increased Energy Shield', 'int_armour, body_armour, focus, helmet, gloves, boots', 'defences', 1000, 'EnergyShieldPercent'),
...
-- Rarity
('RarityPrefix1', 'Dragon', 81, 64, '(23-25)% increased Rarity of Items found', 'ring, amulet, helmet', '', 1000, 'RarityPrefix'),
('RarityPrefix2', 'Pirate', 65, 52, '(20-22)% increased Rarity of Items found', 'ring, amulet, helmet', '', 1000, 'RarityPrefix'),
('RarityPrefix3', 'Hoarder', 47, 37, '(16-19)% increased Rarity of Items found', 'ring, amulet, helmet', '', 1000, 'RarityPrefix'),
('RarityPrefix4', 'Collector', 29, 23, '(12-15)% increased Rarity of Items found', 'ring, amulet, helmet', '', 1000, 'RarityPrefix'),
('RarityPrefix5', 'Magpie', 10, 8, '(8-11)% increased Rarity of Items found', 'ring, amulet, helmet', '', 1000, 'RarityPrefix'),
...
-- Fire Damage
('FireDamageRing1', 'Magmatic', 76, 60, '(27-30)% increased Fire Damage', 'ring', 'damage,elemental,fire', 500, 'FireDamagePercent'),
('FireDamageRing2', 'Volcanic', 64, 51, '(23-26)% increased Fire Damage', 'ring', 'damage,elemental,fire', 500, 'FireDamagePercent'),
('FireDamageRing3', 'Cauterising', 50, 40, '(18-22)% increased Fire Damage', 'ring', 'damage,elemental,fire', 500, 'FireDamagePercent'),
('FireDamageRing4', 'Blistering', 36, 28, '(13-17)% increased Fire Damage', 'ring', 'damage,elemental,fire', 500, 'FireDamagePercent'),
('FireDamageRing5', 'Sizzling', 22, 18, '(8-12)% increased Fire Damage', 'ring', 'damage,elemental,fire', 500, 'FireDamagePercent'),
('FireDamageRing6', 'Searing', 8, 7, '(3-7)% increased Fire Damage', 'ring', 'damage,elemental,fire', 500, 'FireDamagePercent'),

-- Cold Damage
('ColdDamageRing1', 'Crystalline', 76, 60, '(27-30)% increased Cold Damage', 'ring', 'damage,elemental,cold', 500, 'ColdDamagePercent'),
('ColdDamageRing2', 'Hailing', 64, 51, '(23-26)% increased Cold Damage', 'ring', 'damage,elemental,cold', 500, 'ColdDamagePercent'),
('ColdDamageRing3', 'Snowy', 50, 40, '(18-22)% increased Cold Damage', 'ring', 'damage,elemental,cold', 500, 'ColdDamagePercent'),
('ColdDamageRing4', 'Alpine', 36, 28, '(13-17)% increased Cold Damage', 'ring', 'damage,elemental,cold', 500, 'ColdDamagePercent'),
('ColdDamageRing5', 'Biting', 24, 18, '(8-12)% increased Cold Damage', 'ring', 'damage,elemental,cold', 500, 'ColdDamagePercent'),
('ColdDamageRing6', 'Bitter', 10, 7, '(3-7)% increased Cold Damage', 'ring', 'damage,elemental,cold', 500, 'ColdDamagePercent'),

-- Lightning Damage
('LightningDamageRing1', 'Smiting', 76, 60, '(27-30)% increased Lightning Damage', 'ring', 'damage,elemental,lightning', 500, 'LightningDamagePercent'),
('LightningDamageRing2', 'Striking', 64, 51, '(23-26)% increased Lightning Damage', 'ring', 'damage,elemental,lightning', 500, 'LightningDamagePercent'),
('LightningDamageRing3', 'Coursing', 50, 40, '(18-22)% increased Lightning Damage', 'ring', 'damage,elemental,lightning', 500, 'LightningDamagePercent'),
('LightningDamageRing4', 'Bolting', 36, 28, '(13-17)% increased Lightning Damage', 'ring', 'damage,elemental,lightning', 500, 'LightningDamagePercent'),
('LightningDamageRing5', 'Hissing', 23, 18, '(8-12)% increased Lightning Damage', 'ring', 'damage,elemental,lightning', 500, 'LightningDamagePercent'),
('LightningDamageRing6', 'Charged', 9, 7, '(3-7)% increased Lightning Damage', 'ring', 'damage,elemental,lightning', 500, 'LightningDamagePercent'),

-- Chaos Damage
('ChaosDamageRing1', 'Vile', 78, 62, '(27-30)% increased Chaos Damage', 'ring', 'damage,chaos', 500, 'ChaosDamagePercent'),
('ChaosDamageRing2', 'Malignant', 66, 52, '(23-26)% increased Chaos Damage', 'ring', 'damage,chaos', 500, 'ChaosDamagePercent'),
('ChaosDamageRing3', 'Darkened', 52, 41, '(18-22)% increased Chaos Damage', 'ring', 'damage,chaos', 500, 'ChaosDamagePercent'),
('ChaosDamageRing4', 'Clouded', 38, 30, '(13-17)% increased Chaos Damage', 'ring', 'damage,chaos', 500, 'ChaosDamagePercent'),
('ChaosDamageRing5', 'Tainted', 26, 20, '(8-12)% increased Chaos Damage', 'ring', 'damage,chaos', 500, 'ChaosDamagePercent'),
('ChaosDamageRing6', 'Impure', 11, 8, '(3-7)% increased Chaos Damage', 'ring', 'damage,chaos', 500, 'ChaosDamagePercent'),
...
('FlaskLifeRecoveryRate1', 'Regenerating', 77, 61, '(35-40)% increased Flask Life Recovery rate', 'belt', 'life', 800, 'FlaskRecoveryRate'),
('FlaskLifeRecoveryRate2', 'Rejuvenating', 63, 50, '(29-34)% increased Flask Life Recovery rate', 'belt', 'life', 800, 'FlaskRecoveryRate'),
('FlaskLifeRecoveryRate3', 'Refreshing', 49, 39, '(23-28)% increased Flask Life Recovery rate', 'belt', 'life', 800, 'FlaskRecoveryRate'),
('FlaskLifeRecoveryRate4', 'Renewing', 35, 28, '(17-22)% increased Flask Life Recovery rate', 'belt', 'life', 800, 'FlaskRecoveryRate'),
('FlaskLifeRecoveryRate5', 'Recovering', 21, 16, '(11-16)% increased Flask Life Recovery rate', 'belt', 'life', 800, 'FlaskRecoveryRate'),
('FlaskLifeRecoveryRate6', 'Restoring', 5, 4, '(5-10)% increased Flask Life Recovery rate', 'belt', 'life', 800, 'FlaskRecoveryRate'),

-- Flask Mana Recovery Rate
('FlaskManaRecoveryRate1', 'Inspiring', 77, 61, '(35-40)% increased Flask Mana Recovery rate', 'belt', 'mana', 800, 'FlaskRecoveryRate'),
('FlaskManaRecoveryRate2', 'Galvanizing', 63, 50, '(29-34)% increased Flask Mana Recovery rate', 'belt', 'mana', 800, 'FlaskRecoveryRate'),
('FlaskManaRecoveryRate3', 'Exciting', 49, 39, '(23-28)% increased Flask Mana Recovery rate', 'belt', 'mana', 800, 'FlaskRecoveryRate'),
('FlaskManaRecoveryRate4', 'Heartening', 35, 28, '(17-22)% increased Flask Mana Recovery rate', 'belt', 'mana', 800, 'FlaskRecoveryRate'),
('FlaskManaRecoveryRate5', 'Stirring', 21, 16, '(11-16)% increased Flask Mana Recovery rate', 'belt', 'mana', 800, 'FlaskRecoveryRate'),
('FlaskManaRecoveryRate6', 'Affecting', 5, 4, '(5-10)% increased Flask Mana Recovery rate', 'belt', 'mana', 800, 'FlaskRecoveryRate'),

-- Charm Duration
('CharmDuration1', 'Conservative', 75, 60, '(28-33)% increased Charm Effect Duration', 'belt', '', 800, 'CharmDuration'),
('CharmDuration2', 'Innovative', 56, 44, '(22-27)% increased Charm Effect Duration', 'belt', '', 800, 'CharmDuration'),
('CharmDuration3', 'Progressive', 40, 32, '(16-21)% increased Charm Effect Duration', 'belt', '', 800, 'CharmDuration'),
('CharmDuration4', 'Transformative', 24, 19, '(10-15)% increased Charm Effect Duration', 'belt', '', 800, 'CharmDuration'),
('CharmDuration5', 'Conservative', 8, 6, '(4-9)% increased Charm Effect Duration', 'belt', '', 800, 'CharmDuration'),
...
('EnergyShieldManaHybrid1', 'Angel', 78, 62, '(39-42)% increased Energy Shield\n+(33-39) to maximum Mana', 'int_armour, helmet, focus', 'mana,defences', 1000, 'EnergyShieldManaHybrid'),
('EnergyShieldManaHybrid2', 'Heavenly', 60, 48, '(33-38)% increased Energy Shield\n+(27-32) to maximum Mana', 'int_armour, helmet, focus', 'mana,defences', 1000, 'EnergyShieldManaHybrid'),
('EnergyShieldManaHybrid3', 'Celestial', 44, 35, '(27-32)% increased Energy Shield\n+(21-26) to maximum Mana', 'int_armour, helmet, focus', 'mana,defences', 1000, 'EnergyShieldManaHybrid'),
('EnergyShieldManaHybrid4', 'Sacred', 30, 24, '(21-26)% increased Energy Shield\n+(17-20) to maximum Mana', 'int_armour, helmet, focus', 'mana,defences', 1000, 'EnergyShieldManaHybrid'),
('EnergyShieldManaHybrid5', 'Serene', 19, 15, '(14-20)% increased Energy Shield\n+(9-16) to maximum Mana', 'int_armour, helmet, focus', 'mana,defences', 1000, 'EnergyShieldManaHybrid'),
('EnergyShieldManaHybrid6', 'Imbued', 10, 8, '(6-13)% increased Energy Shield\n+(6-8) to maximum Mana', 'int_armour, helmet, focus', 'mana,defences', 1000, 'EnergyShieldManaHybrid'),
...
-- Ruby
-- //
('RubyArmourBreakDuration', 'Resonating', 1, 1, '(10-20)% increased Armour Break Duration', 'ruby', '', 1000, 'ArmourBreakDuration'),
('RubyBleedingDuration', 'Haemophilia', 1, 1, '(5-10)% increased Bleeding Duration', 'ruby', 'bleed,physical,attack,ailment', 1000, 'BleedingDuration'),
('RubyIgniteChance', 'Ignition', 1, 1, '(10-20)% increased chance to Ignite', 'ruby', '', 1000, 'IgniteChance'),
('RubySkillEffectDuration', 'Lengthening', 1, 1, '(5-10)% increased Skill Effect Duration', 'ruby', '', 1000, 'RubySkillEffectDuration'),
('RubyKnockbackDistance', 'Fending', 1, 1, '(5-15)% increased Knockback Distance', 'ruby', '', 1000, 'KnockbackDistance'),
('RubyLifeToManaCost', 'Sacrifice', 1, 1, '(4-6)% of Skill Mana Costs Converted to Life Costs', 'ruby', 'life', 1000, 'LifeToManaCost'),
('RubyLifeLeechAmount', 'Frenzy', 1, 1, '(5-15)% increased amount of Life Leeched', 'ruby', '', 1000, 'LifeLeechAmount'),
('RubyLifeRegenRate', 'Regeneration', 1, 1, '(5-10)% increased Life Regeneration rate', 'ruby', 'life', 1000, 'LifeRegenRate'),
('RubyMaceStunBuildup', 'Thumping', 1, 1, '(15-25)% increased Stun Buildup with Maces', 'ruby', 'attack', 1000, 'MaceStunBuildup'),
('RubyMaxFireRes', 'Phoenix', 1, 1, '+1% to Maximum Fire Resistance', 'ruby', 'elemental,fire,resistance', 1000, 'MaximumFireResistance'),
('RubyMinionPhysDR', 'Confidence', 1, 1, 'Minions have (6-16)% additional Physical Damage Reduction', 'ruby', 'physical,minion', 1000, 'MinionPDR'),
('RubyGainRageOnMeleeHit', 'Raging', 1, 1, 'Gain 1 Rage on Melee Hit', 'ruby', '', 1000, 'GainRageOnMeleeHit'),
('RubyGainRageWhenHit', 'Retribution', 1, 1, 'Gain (1-3) Rage when Hit by an Enemy', 'ruby', '', 1000, 'GainRageWhenHit'),
('RubyStunBuildup', 'Stunning', 1, 1, '(10-20)% increased Stun Buildup', 'ruby', '', 1000, 'StunBuildup'),
('RubyStunThreshold', 'Withstanding', 1, 1, '(6-16)% increased Stun Threshold', 'ruby', '', 1000, 'StunThreshold'),
('RubyTotemPlacementSpeed', 'Ancestry', 1, 1, '(10-20)% increased Totem Placement speed', 'ruby', 'speed', 1000, 'TotemPlacementSpeed'),
('RubyWarcryCooldownRecovery', 'Rallying', 1, 1, '(5-15)% increased Warcry Cooldown Recovery Rate', 'ruby', '', 1000, 'WarcryCooldownRecovery'),
('RubyWarcrySpeed', 'Lungs', 1, 1, '(10-20)% increased Warcry Speed', 'ruby', 'speed', 1000, 'WarcrySpeed'),
('RubyWeaponSwapSpeed', 'Swapping', 1, 1, '(15-25)% increased Weapon Swap Speed', 'ruby', 'attack,speed', 1000, 'WeaponSwapSpeed'),
('RubyValourGained', 'Valour', 1, 1, '(15-20)% increased Valour gained', 'ruby', '', 1000, 'ValourGained'),
('RubyBannerDuration', 'Inspiring', 1, 1, 'Banner Skills have (15-25)% increased Duration', 'ruby', '', 1000, 'BannerDuration'),

-- //
-- Emerald
-- //
('EmeraldAilmentChance', 'Ailing', 1, 1, '(5-15)% increased chance to inflict Ailments', 'emerald', '', 1000, 'EmeraldAilmentChance'),
('EmeraldElementalAilmentThreshold', 'Enduring', 1, 1, '(10-20)% increased Elemental Ailment Threshold', 'emerald', '', 1000, 'ElementalAilmentThreshold'),
('EmeraldCritChance', 'Deadliness', 1, 1, '(6-16)% increased Critical Hit Chance for Attacks', 'emerald', 'attack,critical', 1000, 'EmeraldCritChance'),
('EmeraldCritMulti', 'Demolishing', 1, 1, '(10-20)% increased Critical Damage Bonus for Attack Damage', 'emerald', 'attack,critical', 1000, 'EmeraldCritMulti'),
('EmeraldAttackSpeed', 'Alacrity', 1, 1, '(2-4)% increased Attack Speed', 'emerald', 'attackspeed', 1000, 'AttackSpeed'),
('EmeraldBlindChance', 'Blinding', 1, 1, '(3-7)% chance to Blind Enemies on Hit with Attacks', 'emerald', 'attack', 1000, 'BlindChance'),
('EmeraldBowAttackSpeed', 'Nocking', 1, 1, '(2-4)% increased Attack Speed with Bows', 'emerald', 'attackspeed', 1000, 'WeaponAttackSpeed'),
('EmeraldQuarterstaffAttackSpeed', 'Sequencing', 1, 1, '(2-4)% increased Attack Speed with Quarterstaves', 'emerald', 'attackspeed', 1000, 'WeaponAttackSpeed'),
('EmeraldChainChance', 'Chaining', 1, 1, 'Projectiles have (3-5)% chance to Chain an additional time from terrain', 'emerald', '', 1000, 'ChainChance'),
('EmeraldCharmDuration', 'Woodland', 1, 1, '(5-15)% increased Charm Effect Duration', 'emerald', '', 1000, 'CharmDuration'),
('EmeraldCharmChargeGain', 'Thicker', 1, 1, '(5-15)% increased Charm Charges gained', 'emerald', '', 1000, 'CharmChargeGain'),
('EmeraldCooldownRecovery', 'Chronomancy', 1, 1, '(3-5)% increased Cooldown Recovery Rate', 'emerald', '', 1000, 'CooldownRecovery'),
('EmeraldCrossbowReloadSpeed', 'Reloading', 1, 1, '(10-15)% increased Crossbow Reload Speed', 'emerald', 'attackspeed', 1000, 'CrossbowReloadSpeed'),
('EmeraldCrossbowAttackSpeed', 'Rapidity', 1, 1, '(2-4)% increased Attack Speed with Crossbows', 'emerald', 'attackspeed', 1000, 'CrossbowAttackSpeed'),
('EmeraldAilmentDuration', 'Suffusion', 1, 1, '(5-10)% increased Duration of Damaging Ailments on Enemies', 'emerald', 'ailment', 1000, 'EmeraldAilmentDuration'),
('EmeraldDazeBuildup', 'Dazing', 1, 1, '(10-20)% increased Daze Buildup', 'emerald', '', 1000, 'DazeBuildup'),
('EmeraldDebuffExpire', 'Diminishing', 1, 1, 'Debuffs on you expire (5-10)% faster', 'emerald', '', 1000, 'EmeraldDebuffExpire'),
('EmeraldElementalAilmentDuration', 'Suffering', 1, 1, '(5-10)% increased Duration of Ignite, Shock and Chill on Enemies', 'emerald', 'elemental,ailment', 1000, 'ElementalAilmentDuration'),
('EmeraldAilmentFaster', 'Decrepifying', 1, 1, 'Damaging Ailments deal damage (3-7)% faster', 'emerald', 'ailment', 1000, 'EmeraldAilmentFaster'),
('EmeraldFlaskChargeGain', 'Gathering', 1, 1, '(5-10)% increased Flask Charges gained', 'emerald', '', 1000, 'FlaskChargeGain'),
('EmeraldFlaskEffectDuration', 'Prolonging', 1, 1, '(5-10)% increased Flask Effect Duration', 'emerald', '', 1000, 'FlaskEffectDuration'),
('EmeraldForkChance', 'Forking', 1, 1, 'Projectiles have (10-15)% chance for an additional Projectile when Forking', 'emerald', '', 1000, 'ForkChance'),
('EmeraldLifeFlaskRecovery', 'Recovery', 1, 1, '(5-15)% increased Life Recovery from Flasks', 'emerald', 'life', 1000, 'LifeFlaskRecovery'),
('EmeraldManaFlaskRecovery', 'Quenching', 1, 1, '(5-15)% increased Mana Recovery from Flasks', 'emerald', 'mana', 1000, 'ManaFlaskRecovery'),
('EmeraldLifeFlaskChargeGain', 'Pathfinding', 1, 1, '(5-15)% increased Life Flask Charges gained', 'emerald', 'life', 1000, 'FlaskTypeChargeGain'),
('EmeraldManaFlaskChargeGain', 'Fountains', 1, 1, '(5-15)% increased Mana Flask Charges gained', 'emerald', 'mana', 1000, 'FlaskTypeChargeGain'),
('EmeraldManaLeech', 'Draining', 1, 1, '(5-15)% increased amount of Mana Leeched', 'emerald', 'mana', 1000, 'ManaLeech'),
('EmeraldMarkCastSpeed', 'Targeting', 1, 1, 'Mark Skills have (5-15)% increased Cast Speed', 'emerald', 'speed,curse', 1000, 'MarkCastSpeed'),
('EmeraldMarkSkillDuration', 'Tracking', 1, 1, 'Mark Skills have (18-32)% increased Skill Effect Duration', 'emerald', '', 1000, 'MarkSkillDuration'),
('EmeraldMaxLightningRes', 'Leviathan', 1, 1, '+1% to Maximum Lightning Resistance', 'emerald', 'elemental,lightning,resistance', 1000, 'MaximumLightningResistance'),
('EmeraldMovementSpeed', 'Speed', 1, 1, '(1-2)% increased Movement Speed', 'emerald', 'speed', 1000, 'MovementSpeed'),
('EmeraldPierceChance', 'Piercing', 1, 1, '(10-20)% chance to Pierce an Enemy', 'emerald', '', 1000, 'PierceChance'),
('EmeraldPinBuildup', 'Pinning', 1, 1, '(10-20)% increased Pin Buildup', 'emerald', '', 1000, 'PinBuildup'),
('EmeraldPoisonChance', 'Poisoning', 1, 1, '(5-10)% chance to Poison on Hit', 'emerald', '', 1000, 'PoisonChance'),
('EmeraldPoisonDuration', 'Infection', 1, 1, '(5-10)% increased Poison Duration', 'emerald', 'poison,chaos,ailment', 1000, 'PoisonDuration'),
('EmeraldQuarterstaffFreezeBuildup', 'Glaciers', 1, 1, '(10-20)% increased Freeze Buildup with Quarterstaves', 'emerald', '', 1000, 'EmeraldQuarterstaffFreezeBuildup'),
('EmeraldShockChance', 'Shocking', 1, 1, '(10-20)% increased chance to Shock', 'emerald', '', 1000, 'EmeraldShockChance'),
('EmeraldShockDuration', 'Paralyzing', 1, 1, '(15-25)% increased Shock Duration', 'emerald', 'elemental,lightning,ailment', 1000, 'EmeraldShockDuration'),
('EmeraldReducedSlowPotency', 'Hastening', 1, 1, '(5-10)% reduced Slowing Potency of Debuffs on You', 'emerald', '', 1000, 'ReducedSlowPotency'),
('EmeraldSpearCritMulti', 'Hunting', 1, 1, '(10-20)% increased Critical Damage Bonus with Spears', 'emerald', 'attack,critical', 1000, 'SpearCriticalStrikeMultiplier'),
('EmeraldStunThreshold', 'Stoutness', 1, 1, '(15-25)% increased Stun Threshold if you have not been Stunned Recently', 'emerald', '', 1000, 'StunThresholdIfNotStunned'),

-- //
-- Sapphire
-- //
('SapphireAilmentChance', 'Ailing', 1, 1, '(5-15)% increased chance to inflict Ailments', 'sapphire', '', 1000, 'SapphireAilmentChance'),
('SapphireCastSpeed', 'Enchanting', 1, 1, '(2-4)% increased Cast Speed', 'sapphire', 'caster,speed', 1000, 'CastSpeed'),
('SapphireChillDuration', 'Frost', 1, 1, '(15-25)% increased Chill Duration on Enemies', 'sapphire', 'elemental,cold,ailment', 1000, 'ChillDuration'),
('SapphireCritChance', 'Annihilation', 1, 1, '(5-15)% increased Critical Hit Chance', 'sapphire', 'critical', 1000, 'SapphireCritChance'),
('SapphireCritMulti', 'Potency', 1, 1, '(10-20)% increased Critical Damage Bonus', 'sapphire', 'damage,critical', 1000, 'SapphireSpellCritMulti'),
('SapphireSpellCritMulti', 'Unmaking', 1, 1, '(10-20)% increased Critical Spell Damage Bonus', 'sapphire', 'damage,caster,critical', 1000, 'CriticalSpellDamageBonus'),
('SapphireCurseActivation', 'Chanting', 1, 1, '(5-15)% faster Curse Activation', 'sapphire', 'curse', 1000, 'CurseActivation'),
('SapphireCurseDuration', 'Continuation', 1, 1, '(15-25)% increased Curse Duration', 'sapphire', 'curse', 1000, 'CurseDuration'),
('SapphireManaBeforeLife', 'Mind', 1, 1, '(2-4)% of Damage is taken from Mana before Life', 'sapphire', 'life,mana', 1000, 'ManaBeforeLife'),
('SapphireAilmentDuration', 'Suffusion', 1, 1, '(5-10)% increased Duration of Damaging Ailments on Enemies', 'sapphire', 'ailment', 1000, 'SapphireAilmentDuration'),
('SapphireDebuffExpire', 'Diminishing', 1, 1, 'Debuffs on you expire (5-10)% faster', 'sapphire', '', 1000, 'SapphireDebuffExpire'),
('SapphireMetaSkillEnergy', 'Generation', 1, 1, 'Meta Skills gain (4-8)% increased Energy', 'sapphire', '', 1000, 'MetaSkillEnergy'),
('SapphireAilmentFaster', 'Decrepifying', 1, 1, 'Damaging Ailments deal damage (3-7)% faster', 'sapphire', 'ailment', 1000, 'SapphireAilmentFaster'),
('SapphireFreezeBuildup', 'Freezing', 1, 1, '(10-20)% increased Freeze Buildup', 'sapphire', '', 1000, 'FreezeBuildup'),
('SapphireFreezeThreshold', 'Snowbreathing', 1, 1, '(18-32)% increased Freeze Threshold', 'sapphire', 'damage', 1000, 'FreezeThreshold'),
('SapphireIgniteChance', 'Ignition', 1, 1, '(10-20)% increased chance to Ignite', 'sapphire', '', 1000, 'IgniteChance'),
('SapphireSkillEffectDuration', 'Lengthening', 1, 1, '(5-10)% increased Skill Effect Duration', 'sapphire', '', 1000, 'SapphireSkillEffectDuration'),
('SapphireLifeOnKill', 'Success', 1, 1, 'Recover (1-2)% of maximum Life on Kill', 'sapphire', 'life', 1000, 'LifeOnKill'),
('SapphireLifeRecoup', 'Infusion', 1, 1, '(2-3)% of Damage taken Recouped as Life', 'sapphire', 'life', 1000, 'LifeRecoup'),
('SapphireManaOnKill', 'Osmosis', 1, 1, 'Recover (1-2)% of maximum Mana on Kill', 'sapphire', 'mana', 1000, 'ManaOnKill'),
('SapphireManaRegen', 'Energy', 1, 1, '(5-15)% increased Mana Regeneration Rate', 'sapphire', 'mana', 1000, 'ManaRegeneration'),
('SapphireMaxColdRes', 'Kraken', 1, 1, '+1% to Maximum Cold Resistance', 'sapphire', 'elemental,cold,resistance', 1000, 'MaximumColdResistance'),
('SapphireMinionAtkCastSpeed', 'Orchestration', 1, 1, 'Minions have (2-4)% increased Attack and Cast Speed', 'sapphire', 'attack,caster,speed,minion', 1000, 'MinionAtkCastSpeed'),
('SapphireMinionChaosRes', 'Righteousness', 1, 1, 'Minions have +(7-13)% to Chaos Resistance', 'sapphire', 'chaos,resistance,minion', 1000, 'MinionChaosResistance'),
('SapphireMinionCritChance', 'Marshalling', 1, 1, 'Minions have (10-20)% increased Critical Hit Chance', 'sapphire', 'minion,critical', 1000, 'MinionCritChance'),
('SapphireMinionCritMulti', 'Gripping', 1, 1, 'Minions have (15-25)% increased Critical Damage Bonus', 'sapphire', 'damage,minion,critical', 1000, 'MinionCritMulti'),
('SapphireMinionAllRes', 'Acclimatisation', 1, 1, 'Minions have +(5-10)% to all Elemental Resistances', 'sapphire', 'elemental,resistance,minion', 1000, 'MinionAllResistances'),
('SapphireOfferingDuration', 'Offering', 1, 1, 'Offering Skills have (15-25)% increased Duration', 'sapphire', '', 1000, 'OfferingDuration'),
('SapphireQuarterstaffFreezeBuildup', 'Glaciers', 1, 1, '(10-20)% increased Freeze Buildup with Quarterstaves', 'sapphire', '', 1000, 'SapphireQuarterstaffFreezeBuildup'),
('SapphireShockChance', 'Shocking', 1, 1, '(10-20)% increased chance to Shock', 'sapphire', '', 1000, 'SapphireShockChance'),
('SapphireShockDuration', 'Paralyzing', 1, 1, '(15-25)% increased Shock Duration', 'sapphire', 'elemental,lightning,ailment', 1000, 'SapphireShockDuration'),
('SapphireSpellCritChance', 'Annihilating', 1, 1, '(5-15)% increased Critical Hit Chance for Spells', 'sapphire', 'caster,critical', 1000, 'SpellCriticalStrikeChance'),
('SapphireStunThresholdFromES', 'Barriers', 1, 1, 'Gain additional Stun Threshold equal to (5-15)% of maximum Energy Shield', 'sapphire', '', 1000, 'StunThresholdFromES'),
('SapphireAilmentThresholdFromES', 'Inuring', 1, 1, 'Gain additional Ailment Threshold equal to (5-15)% of maximum Energy Shield', 'sapphire', 'ailment', 1000, 'AilmentThresholdFromES'),
...
('SpellSkillGemLevel3', 'Enchanter', 25, 20, '+2 to Level of all Spell Skills', 'wand, amulet, focus', 'caster,gem', 150, 'IncreaseGemLevel'),
('SpellSkillGemLevel4', 'Mage', 5, 4, '+1 to Level of all Spell Skills', 'wand, amulet, focus', 'caster,gem', 200, 'IncreaseGemLevel'),
...
-- Life Leech
('LifeLeech1', 'Vampire', 81, 64, 'Leeches (9-9.9)% of Physical Damage as Life', 'weapon, bow, gloves', 'life, physical, attack', 1000, 'LifeLeech'),
('LifeLeech2', 'Lamprey', 68, 54, 'Leeches (8-8.9)% of Physical Damage as Life', 'weapon, bow, gloves', 'life, physical, attack', 1000, 'LifeLeech'),
('LifeLeech3', 'Remora', 54, 43, 'Leeches (7-7.9)% of Physical Damage as Life', 'weapon, bow, gloves', 'life, physical, attack', 1000, 'LifeLeech'),
('LifeLeech4', 'Locust', 38, 30, 'Leeches (6-6.9)% of Physical Damage as Life', 'weapon, bow, gloves', 'life, physical, attack', 1000, 'LifeLeech'),
('LifeLeech5', 'Parasite', 21, 16, 'Leeches (5-5.9)% of Physical Damage as Life', 'weapon, bow, gloves', 'life, physical, attack', 1000, 'LifeLeech'),

-- Mana Leech
('ManaLeech1', 'Desperate', 81, 64, 'Leeches (8-8.9)% of Physical Damage as Mana', 'weapon, bow, gloves', 'mana, physical, attack', 1000, 'ManaLeech'),
('ManaLeech2', 'Drought', 68, 54, 'Leeches (7-7.9)% of Physical Damage as Mana', 'weapon, bow, gloves', 'mana, physical, attack', 1000, 'ManaLeech'),
('ManaLeech3', 'Arid', 54, 43, 'Leeches (6-6.9)% of Physical Damage as Mana', 'weapon, bow, gloves', 'mana, physical, attack', 1000, 'ManaLeech'),
('ManaLeech4', 'Parched', 38, 30, 'Leeches (5-5.9)% of Physical Damage as Mana', 'weapon, bow, gloves', 'mana, physical, attack', 1000, 'ManaLeech'),
('ManaLeech5', 'Thirsty', 21, 16, 'Leeches (4-4.9)% of Physical Damage as Mana', 'weapon, bow, gloves', 'mana, physical, attack', 1000, 'ManaLeech'),

-- Life on Hit
('LifeOnHit1', 'Nourishment', 40, 32, 'Grants 5 Life per Enemy Hit', 'weapon, bow', 'life,attack', 1000, 'LifeOnHit'),
('LifeOnHit2', 'Regrowth', 30, 24, 'Grants 4 Life per Enemy Hit', 'weapon, bow', 'life,attack', 1000, 'LifeOnHit'),
('LifeOnHit3', 'Restoration', 20, 16, 'Grants 3 Life per Enemy Hit', 'weapon, bow', 'life,attack', 1000, 'LifeOnHit'),
('LifeOnHit4', 'Rejuvenation', 8, 6, 'Grants 2 Life per Enemy Hit', 'weapon, bow', 'life,attack', 1000, 'LifeOnHit'),
...
('IncreasedAttackSpeed4', 'Acclaim', 37, 29, '(17-19)% increased Attack Speed', 'weapon, bow', 'attack, speed', 500, 'IncreasedAttackSpeed'),
('IncreasedAttackSpeed5', 'Renown', 30, 24, '(14-16)% increased Attack Speed', 'weapon, bow, gloves, quiver', 'attack, speed', 1000, 'IncreasedAttackSpeed'),
('IncreasedAttackSpeed6', 'Mastery', 22, 17, '(11-13)% increased Attack Speed', 'weapon, bow, gloves, quiver', 'attack, speed', 1000, 'IncreasedAttackSpeed'),
('IncreasedAttackSpeed7', 'Ease', 11, 8, '(8-10)% increased Attack Speed', 'weapon, bow, gloves, quiver', 'attack, speed', 1000, 'IncreasedAttackSpeed'),
('IncreasedAttackSpeed8', 'Skill', 1, 1, '(5-7)% increased Attack Speed', 'weapon, bow, gloves, quiver', 'attack, speed', 1000, 'IncreasedAttackSpeed'),

-- Crit Chance
('CriticalStrikeChance1', 'Unmaking', 73, 58, '+(4.41-5)% to Critical Hit Chance', 'weapon, bow', 'attack,critical', 125, 'CriticalStrikeChance'),
('CriticalStrikeChance2', 'Ruin', 59, 47, '+(3.81-4.4)% to Critical Hit Chance', 'weapon, bow', 'attack,critical', 250, 'CriticalStrikeChance'),
('CriticalStrikeChance3', 'Calamity', 44, 35, '+(3.11-3.8)% to Critical Hit Chance', 'weapon, bow', 'attack,critical', 500, 'CriticalStrikeChance'),
('CriticalStrikeChance4', 'Disaster', 30, 24, '+(2.11-2.7)% to Critical Hit Chance', 'weapon, bow', 'attack,critical', 1000, 'CriticalStrikeChance'),
('CriticalStrikeChance5', 'Havoc', 20, 16, '+(1.51-2.1)% to Critical Hit Chance', 'weapon, bow', 'attack,critical', 1000, 'CriticalStrikeChance'),
('CriticalStrikeChance6', 'Menace', 1, 1, '+(1.01-1.5)% to Critical Hit Chance', 'weapon, bow', 'attack,critical', 1000, 'CriticalStrikeChance'),

-- Crit Multi
('CriticalStrikeMultiplier1', 'Destruction', 73, 58, '+(35-39)% to Critical Damage Bonus', 'weapon, bow', 'damage,attack,critical', 125, 'CriticalStrikeMultiplier'),
('CriticalStrikeMultiplier2', 'Ferocity', 59, 47, '+(30-34)% to Critical Damage Bonus', 'weapon, bow', 'damage,attack,critical', 250, 'CriticalStrikeMultiplier'),
('CriticalStrikeMultiplier3', 'Fury', 44, 35, '+(25-29)% to Critical Damage Bonus', 'weapon, bow', 'damage,attack,critical', 500, 'CriticalStrikeMultiplier'),
('CriticalStrikeMultiplier4', 'Rage', 30, 24, '+(20-24)% to Critical Damage Bonus', 'weapon, bow', 'damage,attack,critical', 1000, 'CriticalStrikeMultiplier'),
('CriticalStrikeMultiplier5', 'Anger', 21, 16, '+(15-19)% to Critical Damage Bonus', 'weapon, bow', 'damage,attack,critical', 1000, 'CriticalStrikeMultiplier'),
('CriticalStrikeMultiplier6', 'Ire', 8, 6, '+(10-14)% to Critical Damage Bonus', 'weapon, bow', 'damage,attack,critical', 1000, 'CriticalStrikeMultiplier'),

-- Light Radius
('LightRadiusAndAccuracy1', 'Radiance', 30, 24, '+(41-60) to Accuracy Rating\n15% increased Light Radius', 'weapon, bow, helmet', 'attack', 1000, 'LightRadiusAndAccuracy'),
('LightRadiusAndAccuracy2', 'Light', 15, 12, '+(21-40) to Accuracy Rating\n10% increased Light Radius', 'weapon, bow, helmet', 'attack', 1000, 'LightRadiusAndAccuracy'),
('LightRadiusAndAccuracy3', 'Shining', 8, 6, '+(10-20) to Accuracy Rating\n5% increased Light Radius', 'weapon, bow, helmet', 'attack', 1000, 'LightRadiusAndAccuracy'),
...
-- Ignite Chance
('IgniteChance1', 'Conflagration', 75, 60, '(91-100)% increased chance to Ignite', 'wand, staff', 'elemental,fire', 500, 'Ailment'),
('IgniteChance2', 'Combustion', 60, 48, '(81-90)% increased chance to Ignite', 'wand, staff', 'elemental,fire', 500, 'Ailment'),
('IgniteChance3', 'Incineration', 45, 36, '(71-80)% increased chance to Ignite', 'wand, staff', 'elemental,fire', 1000, 'Ailment'),
('IgniteChance4', 'Scorching', 30, 24, '(61-70)% increased chance to Ignite', 'wand, staff', 'elemental,fire', 1000, 'Ailment'),
('IgniteChance5', 'Ignition', 15, 12, '(51-60)% increased chance to Ignite', 'wand, staff', 'elemental,fire', 1000, 'Ailment'),

-- Freeze Buildup
('FreezeBuildup1', 'Arctic', 75, 60, '(71-80)% increased Freeze Buildup', 'wand, staff', 'elemental,cold', 500, 'Ailment'),
('FreezeBuildup2', 'Hyperboreal', 60, 48, '(61-70)% increased Freeze Buildup', 'wand, staff', 'elemental,cold', 500, 'Ailment'),
('FreezeBuildup3', 'Glacier', 45, 36, '(51-60)% increased Freeze Buildup', 'wand, staff', 'elemental,cold', 1000, 'Ailment'),
('FreezeBuildup4', 'Bleakness', 30, 24, '(41-50)% increased Freeze Buildup', 'wand, staff', 'elemental,cold', 1000, 'Ailment'),
('FreezeBuildup5', 'Freezing', 15, 12, '(31-40)% increased Freeze Buildup', 'wand, staff', 'elemental,cold', 1000, 'Ailment'),

-- Shock Chance
('ShockChance1', 'Thunderbolt', 75, 60, '(91-100)% increased chance to Shock', 'wand, staff', 'elemental,lightning', 500, 'Ailment'),
('ShockChance2', 'Voltages', 60, 48, '(81-90)% increased chance to Shock', 'wand, staff', 'elemental,lightning', 500, 'Ailment'),
('ShockChance3', 'Electrocution', 45, 36, '(71-80)% increased chance to Shock', 'wand, staff', 'elemental,lightning', 1000, 'Ailment'),
('ShockChance4', 'Zapping', 30, 24, '(61-70)% increased chance to Shock', 'wand, staff', 'elemental,lightning', 1000, 'Ailment'),
('ShockChance5', 'Shocking', 15, 12, '(51-60)% increased chance to Shock', 'wand, staff', 'elemental,lightning', 1000, 'Ailment'),
...
-- Int
('Intelligence1', 'Virtuoso', 74, 59, '+(31-33) to Intelligence', 'ring, amulet, helmet, int_armour, str_int_armour, dex_int_armour, dagger, quarterstaff, flail, focus, wand, staff, sceptre', 'attribute', 1000, 'Intelligence'),
('Intelligence2', 'Savant', 66, 52, '+(28-30) to Intelligence', 'ring, amulet, helmet, int_armour, str_int_armour, dex_int_armour, dagger, quarterstaff, flail, focus, wand, staff, sceptre', 'attribute', 1000, 'Intelligence'),
('Intelligence3', 'Sage', 55, 44, '+(25-27) to Intelligence', 'ring, amulet, helmet, int_armour, str_int_armour, dex_int_armour, dagger, quarterstaff, flail, focus, wand, staff, sceptre', 'attribute', 1000, 'Intelligence'),
('Intelligence4', 'Philosopher', 44, 35, '+(21-24) to Intelligence', 'ring, amulet, helmet, int_armour, str_int_armour, dex_int_armour, dagger, quarterstaff, flail, focus, wand, staff, sceptre', 'attribute', 1000, 'Intelligence'),
('Intelligence5', 'Augur', 33, 26, '+(17-20) to Intelligence', 'ring, amulet, helmet, int_armour, str_int_armour, dex_int_armour, dagger, quarterstaff, flail, focus, wand, staff, sceptre', 'attribute', 1000, 'Intelligence'),
('Intelligence6', 'Prodigy', 22, 17, '+(13-16) to Intelligence', 'ring, amulet, helmet, int_armour, str_int_armour, dex_int_armour, dagger, quarterstaff, flail, focus, wand, staff, sceptre', 'attribute', 1000, 'Intelligence'),
('Intelligence7', 'Student', 11, 8, '+(9-12) to Intelligence', 'ring, amulet, helmet, int_armour, str_int_armour, dex_int_armour, dagger, quarterstaff, flail, focus, wand, staff, sceptre', 'attribute', 1000, 'Intelligence'),
('Intelligence8', 'Pupil', 1, 1, '+(5-8) to Intelligence', 'ring, amulet, helmet, int_armour, str_int_armour, dex_int_armour, dagger, quarterstaff, flail, focus, wand, staff, sceptre', 'attribute', 1000, 'Intelligence'),
...
-- Fire Resistance
('FireResistance1', 'Tzteosh', 82, 65, '+(41-45)% to Fire Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,fire,resistance', 1000, 'FireResistance'),
('FireResistance2', 'Magma', 71, 56, '+(36-40)% to Fire Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,fire,resistance', 1000, 'FireResistance'),
('FireResistance3', 'Volcano', 60, 48, '+(31-35)% to Fire Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,fire,resistance', 1000, 'FireResistance'),
('FireResistance4', 'Furnace', 48, 38, '+(26-30)% to Fire Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,fire,resistance', 1000, 'FireResistance'),
('FireResistance5', 'Kiln', 36, 28, '+(21-25)% to Fire Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,fire,resistance', 1000, 'FireResistance'),
('FireResistance6', 'Drake', 24, 19, '+(16-20)% to Fire Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,fire,resistance', 1000, 'FireResistance'),
('FireResistance7', 'Salamander', 12, 9, '+(11-15)% to Fire Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,fire,resistance', 1000, 'FireResistance'),
('FireResistance8', 'Whelpling', 1, 1, '+(6-10)% to Fire Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,fire,resistance', 1000, 'FireResistance'),

-- Cold Resistance
('ColdResistance1', 'Haast', 82, 65, '+(41-45)% to Cold Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,cold,resistance', 1000, 'ColdResistance'),
('ColdResistance2', 'Ice', 71, 56, '+(36-40)% to Cold Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,cold,resistance', 1000, 'ColdResistance'),
('ColdResistance3', 'Polar Bear', 60, 48, '+(31-35)% to Cold Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,cold,resistance', 1000, 'ColdResistance'),
('ColdResistance4', 'Walrus', 50, 40, '+(26-30)% to Cold Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,cold,resistance', 1000, 'ColdResistance'),
('ColdResistance5', 'Yeti', 38, 30, '+(21-25)% to Cold Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,cold,resistance', 1000, 'ColdResistance'),
('ColdResistance6', 'Narwhal', 26, 20, '+(16-20)% to Cold Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,cold,resistance', 1000, 'ColdResistance'),
('ColdResistance7', 'Penguin', 14, 11, '+(11-15)% to Cold Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,cold,resistance', 1000, 'ColdResistance'),
('ColdResistance8', 'Seal', 1, 1, '+(6-10)% to Cold Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,cold,resistance', 1000, 'ColdResistance'),

-- Lightning Resistance
('LightningResistance1', 'Ephij', 82, 65, '+(41-45)% to Lightning Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,lightning,resistance', 1000, 'LightningResistance'),
('LightningResistance2', 'Lightning', 71, 56, '+(36-40)% to Lightning Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,lightning,resistance', 1000, 'LightningResistance'),
('LightningResistance3', 'Maelstrom', 60, 48, '+(31-35)% to Lightning Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,lightning,resistance', 1000, 'LightningResistance'),
('LightningResistance4', 'Tempest', 49, 39, '+(26-30)% to Lightning Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,lightning,resistance', 1000, 'LightningResistance'),
('LightningResistance5', 'Thunderhead', 37, 29, '+(21-25)% to Lightning Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,lightning,resistance', 1000, 'LightningResistance'),
('LightningResistance6', 'Storm', 25, 20, '+(16-20)% to Lightning Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,lightning,resistance', 1000, 'LightningResistance'),
('LightningResistance7', 'Squall', 13, 10, '+(11-15)% to Lightning Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,lightning,resistance', 1000, 'LightningResistance'),
('LightningResistance8', 'Cloud', 1, 1, '+(6-10)% to Lightning Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'elemental,lightning,resistance', 1000, 'LightningResistance'),

-- Chaos Resistance
('ChaosResistance1', 'Bameth', 81, 64, '+(24-27)% to Chaos Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'chaos,resistance', 250, 'ChaosResistance'),
('ChaosResistance2', 'Exile', 68, 54, '+(20-23)% to Chaos Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'chaos,resistance', 250, 'ChaosResistance'),
('ChaosResistance3', 'Expulsion', 56, 44, '+(16-19)% to Chaos Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'chaos,resistance', 250, 'ChaosResistance'),
('ChaosResistance4', 'Eviction', 44, 35, '+(12-15)% to Chaos Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'chaos,resistance', 250, 'ChaosResistance'),
('ChaosResistance5', 'Banishment', 30, 24, '+(8-11)% to Chaos Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'chaos,resistance', 250, 'ChaosResistance'),
('ChaosResistance6', 'Lost', 16, 12, '+(4-7)% to Chaos Resistance', 'armour, helmet, body_armour, gloves, boots, shield, focus, ring, amulet, belt', 'chaos,resistance', 250, 'ChaosResistance'),

-- Attribute Requirements
('AttributeRequirements1', 'Proficient', 60, 48, '35% reduced Attribute Requirements', 'weapon, bow, armour, helmet, body_armour, gloves, boots, shield, focus, sceptre, staff, wand', '', 1000, 'AttributeRequirements'),
('AttributeRequirements2', 'Skilled', 52, 41, '30% reduced Attribute Requirements', 'weapon, bow, armour, helmet, body_armour, gloves, boots, shield, focus, sceptre, staff, wand', '', 1000, 'AttributeRequirements'),
('AttributeRequirements3', 'Talented', 40, 32, '25% reduced Attribute Requirements', 'weapon, bow, armour, helmet, body_armour, gloves, boots, shield, focus, sceptre, staff, wand', '', 1000, 'AttributeRequirements'),
('AttributeRequirements4', 'Apt', 32, 25, '20% reduced Attribute Requirements', 'weapon, bow, armour, helmet, body_armour, gloves, boots, shield, focus, sceptre, staff, wand', '', 1000, 'AttributeRequirements'),
('AttributeRequirements5', 'Worthy', 24, 19, '15% reduced Attribute Requirements', 'weapon, bow, armour, helmet, body_armour, gloves, boots, shield, focus, sceptre, staff, wand', '', 1000, 'AttributeRequirements'),

-- Life per Kill
('LifeGainedFromEnemyDeath1', 'Legend', 77, 61, 'Gain (69-84) Life per Enemy Killed', 'weapon, bow, staff, wand', 'life, resource', 750, 'LifeGainedFromEnemyDeath'),
('LifeGainedFromEnemyDeath2', 'Glory', 66, 52, 'Gain (54-68) Life per Enemy Killed', 'weapon, bow, staff, wand', 'life, resource', 750, 'LifeGainedFromEnemyDeath'),
('LifeGainedFromEnemyDeath3', 'Valour', 55, 44, 'Gain (41-53) Life per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'life, resource', 750, 'LifeGainedFromEnemyDeath'),
('LifeGainedFromEnemyDeath4', 'Vanquishing', 44, 35, 'Gain (29-40) Life per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'life, resource', 750, 'LifeGainedFromEnemyDeath'),
('LifeGainedFromEnemyDeath5', 'Conquest', 33, 26, 'Gain (19-28) Life per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'life, resource', 750, 'LifeGainedFromEnemyDeath'),
('LifeGainedFromEnemyDeath6', 'Triumph', 22, 17, 'Gain (10-18) Life per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'life, resource', 750, 'LifeGainedFromEnemyDeath'),
('LifeGainedFromEnemyDeath7', 'Victory', 11, 8, 'Gain (7-9) Life per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'life, resource', 750, 'LifeGainedFromEnemyDeath'),
('LifeGainedFromEnemyDeath8', 'Success', 1, 1, 'Gain (4-6) Life per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'life, resource', 750, 'LifeGainedFromEnemyDeath'),

-- Mana per Kill
('ManaGainedFromEnemyDeath1', 'Assimilation', 78, 62, 'Gain (36-45) Mana per Enemy Killed', 'weapon, bow, staff, wand', 'mana, resource', 750, 'ManaGainedFromEnemyDeath'),
('ManaGainedFromEnemyDeath2', 'Devouring', 67, 53, 'Gain (28-35) Mana per Enemy Killed', 'weapon, bow, staff, wand', 'mana, resource', 750, 'ManaGainedFromEnemyDeath'),
('ManaGainedFromEnemyDeath3', 'Siphoning', 56, 44, 'Gain (21-27) Mana per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'mana, resource', 750, 'ManaGainedFromEnemyDeath'),
('ManaGainedFromEnemyDeath4', 'Consumption', 45, 36, 'Gain (15-20) Mana per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'mana, resource', 750, 'ManaGainedFromEnemyDeath'),
('ManaGainedFromEnemyDeath5', 'Enveloping', 34, 27, 'Gain (10-14) Mana per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'mana, resource', 750, 'ManaGainedFromEnemyDeath'),
('ManaGainedFromEnemyDeath6', 'Infusion', 23, 18, 'Gain (6-9) Mana per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'mana, resource', 750, 'ManaGainedFromEnemyDeath'),
('ManaGainedFromEnemyDeath7', 'Osmosis', 12, 9, 'Gain (4-5) Mana per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'mana, resource', 750, 'ManaGainedFromEnemyDeath'),
('ManaGainedFromEnemyDeath8', 'Absorption', 1, 1, 'Gain (2-3) Mana per Enemy Killed', 'weapon, bow, staff, wand, ring, gloves, quiver', 'mana, resource', 750, 'ManaGainedFromEnemyDeath'),
...
-- Rarity
('RaritySuffix1', 'Windfall', 75, 60, '(22-25)% increased Rarity of Items found', 'ring, amulet, gloves, boots, helmet', '', 1000, 'RaritySuffix'),
('RaritySuffix2', 'Excavation', 63, 50, '(19-21)% increased Rarity of Items found', 'ring, amulet, gloves, boots, helmet', '', 1000, 'RaritySuffix'),
('RaritySuffix3', 'Archaeology', 40, 32, '(15-18)% increased Rarity of Items found', 'ring, amulet, gloves, boots, helmet', '', 1000, 'RaritySuffix'),
('RaritySuffix4', 'Raiding', 24, 19, '(11-14)% increased Rarity of Items found', 'ring, amulet, gloves, boots, helmet', '', 1000, 'RaritySuffix'),
('RaritySuffix5', 'Plunder', 3, 2, '(6-10)% increased Rarity of Items found', 'ring, amulet, gloves, boots, helmet', '', 1000, 'RaritySuffix'),
...
-- Recoup
('LifeRecoupAmulet1', 'Mending', 79, 63, '(22-24)% of Damage taken Recouped as Life', 'amulet', 'life', 500, 'LifeRecoup'),
('LifeRecoupAmulet2', 'Suturing', 68, 54, '(19-21)% of Damage taken Recouped as Life', 'amulet', 'life', 500, 'LifeRecoup'),
('LifeRecoupAmulet3', 'Stitching', 56, 44, '(16-18)% of Damage taken Recouped as Life', 'amulet', 'life', 500, 'LifeRecoup'),
('LifeRecoupAmulet4', 'Bandaging', 44, 35, '(13-15)% of Damage taken Recouped as Life', 'amulet', 'life', 500, 'LifeRecoup'),
('LifeRecoupAmulet5', 'Mending', 30, 24, '(10-12)% of Damage taken Recouped as Life', 'amulet', 'life', 500, 'LifeRecoup'),

('ManaRecoupAmulet1', 'Zen', 80, 63, '(22-24)% of Damage taken Recouped as Mana', 'amulet', 'life,mana', 500, 'ManaRecoup'),
('ManaRecoupAmulet2', 'Serenity', 69, 55, '(19-21)% of Damage taken Recouped as Mana', 'amulet', 'life,mana', 500, 'ManaRecoup'),
('ManaRecoupAmulet3', 'Tranquility', 57, 45, '(16-18)% of Damage taken Recouped as Mana', 'amulet', 'life,mana', 500, 'ManaRecoup'),
('ManaRecoupAmulet4', 'Solace', 45, 36, '(13-15)% of Damage taken Recouped as Mana', 'amulet', 'life,mana', 500, 'ManaRecoup'),
('ManaRecoupAmulet5', 'Reprieve', 31, 24, '(10-12)% of Damage taken Recouped as Mana', 'amulet', 'life,mana', 500, 'ManaRecoup'),
...
('LifeOnHitGloves4', 'Rejuvenation', 8, 6, 'Grants 2 Life per Enemy Hit with Attacks', 'gloves', 'life,attack', 1000, 'LifeOnHitGloves'),

-- Boots
('StunThreshold0', 'Titanium Skin', 80, 64, '+(305-352) to Stun Threshold', 'boots', '', 800, 'StunThreshold'),
...
-- Crossbow
('ProjectileSkillGemLevelCrossbow1', 'Sniper', 81, 64, '+7 to Level of all Projectile Skills', 'crossbow', 'attack', 100, 'IncreaseGemLevel'),
('ProjectileSkillGemLevelCrossbow2', 'Marksman', 55, 44, '+(5-6) to Level of all Projectile Skills', 'crossbow', 'attack', 250, 'IncreaseGemLevel'),
('ProjectileSkillGemLevelCrossbow3', 'Sharpshooter', 36, 28, '+4 to Level of all Projectile Skills', 'crossbow', 'attack', 500, 'IncreaseGemLevel'),
('ProjectileSkillGemLevelCrossbow4', 'Fletcher', 18, 14, '+3 to Level of all Projectile Skills', 'crossbow', 'attack', 750, 'IncreaseGemLevel'),
('ProjectileSkillGemLevelCrossbow5', 'Archer', 2, 1, '+(1-2) to Level of all Projectile Skills', 'crossbow', 'attack', 1000, 'IncreaseGemLevel'),
...
-- Bow
('ProjectileSkillGemLevel1', 'Sniper', 81, 64, '+5 to Level of all Projectile Skills', 'bow, spear', 'attack', 100, 'IncreaseGemLevel'),
('ProjectileSkillGemLevel2', 'Marksman', 55, 44, '+4 to Level of all Projectile Skills', 'bow, spear', 'attack', 250, 'IncreaseGemLevel'),
('ProjectileSkillGemLevel3', 'Sharpshooter', 36, 28, '+3 to Level of all Projectile Skills', 'bow, amulet, spear', 'attack', 500, 'IncreaseGemLevel'),
('ProjectileSkillGemLevel4', 'Fletcher', 18, 14, '+2 to Level of all Projectile Skills', 'bow, amulet, spear, quiver', 'attack', 750, 'IncreaseGemLevel'),
('ProjectileSkillGemLevel5', 'Archer', 2, 1, '+1 to Level of all Projectile Skills', 'bow, amulet, spear, quiver', 'attack', 1000, 'IncreaseGemLevel'),
...
('MaximumChaosResistance1', 'Harmony', 81, 64, '+3% to Maximum Chaos Resistance', 'str_shield, str_dex_shield, str_int_shield, dex_shield', 'chaos,resistance', 250, 'MaximumChaosResistance'),
('MaximumChaosResistance2', 'Concord', 75, 60, '+2% to Maximum Chaos Resistance', 'str_shield, str_dex_shield, str_int_shield, dex_shield', 'chaos,resistance', 250, 'MaximumChaosResistance'),
('MaximumChaosResistance3', 'Regularity', 68, 54, '+1% to Maximum Chaos Resistance', 'str_shield, str_dex_shield, str_int_shield, dex_shield', 'chaos,resistance', 250, 'MaximumChaosResistance'),
